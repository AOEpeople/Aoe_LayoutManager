<?php
/**
 * Layout Manager Resource Model
 *
 * @category    Aoe
 * @package     Aoe_LayoutManager
 * @author      Manish Jain
 */
class  Aoe_LayoutManager_Model_Resource_Layout extends Mage_Core_Model_Resource_Layout
{
    /**
     * Process layout data before saving
     *
     * @param Mage_Core_Model_Abstract $object
     * @return Aoe_LayoutManager_Model_Resource_Layout
     */
     ...
     *
     * @param Aoe_LayoutManager_Model_Layout $object
     * @return Aoe_LayoutManager_Model_Resource_Layout
     */
     ...
     *
     * @param Aoe_LayoutManager_Model_Layout $layoutInstance
